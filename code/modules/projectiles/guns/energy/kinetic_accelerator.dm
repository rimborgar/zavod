/obj/item/gun/energy/kinetic_accelerator
	...
	desc = "A self recharging, ranged self-defense and rock pulverizing tool that does increased damage in low pressure. EXOCOM does not condone use of this weapon against other sophontic life."
